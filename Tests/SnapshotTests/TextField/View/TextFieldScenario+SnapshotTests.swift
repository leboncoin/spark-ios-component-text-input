...
struct TextFieldScenario: CustomStringConvertible {
    ...
    static let test5: TextFieldScenario = .init(
        description: "Test5",
        statesArray: [.`default`],
        intents: TextInputIntent.allCases,
        texts: [.normal],
        leftContents: [.none],
        rightContents: [.none],
        modes: ComponentSnapshotTestConstants.Modes.all,
    ...
    func getTestName(intent: TextInputIntent, states: TextFieldScenarioStates, text: TextFieldScenarioText, leftContent: TextFieldScenarioSideContentOptionSet, rightContent: TextFieldScenarioSideContentOptionSet) -> String {
